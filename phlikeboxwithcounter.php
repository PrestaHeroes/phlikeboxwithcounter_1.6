...
class Phlikeboxwithcounter extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->ps_versions_compliancy = array('min' => '1.6.0.7', 'max' => '1.6.99.99');
    }
    ...
    */
    ...
    public function displayWidget($hookName, array $params)
    {
        ...
        return $this->display(__FILE__, 'displayWidget.tpl');
    }
    ...
    /**
     * Return as array of data to be used in smarty template
     * @return array
     */
